...
import ScoreTable from '../quiz/ScoreTable';
        ...
        <div className="grid lg:grid-cols-2 gap-5 mb-16 h-480">
          ...
          <div className="card">
            ...
            <div className="card-body my-4 ">
              <h5 className="card-title text-center" >Your Result Here</h5>
              <div className="rounded bg-white h-40 shadow-sm " style={{ height: '150px', overflow: 'auto'}}>
                 <ScoreTable/>
             </div> 
